...
public class AESUtils {
     ...
     * 偏移量,必须是16位字符串
     */
    private static final String IV_STRING = "musicallifesgood";

    /**
     * 默认的密钥
     */
    public static final String DEFAULT_KEY = "7504b3b9849a4652";//7504b3b9849a4652
    ...
    public static void main(String[] args) {
        ...
        String encodeS = encryptData(DEFAULT_KEY, s);
        System.out.println(encodeS);
        System.out.println(decryptData(DEFAULT_KEY, encodeS));
