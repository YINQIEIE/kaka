...
//    private static final String PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQChYVo+X65pgeVMC3sIljiUE3OrBGYqTnU+kSYiICfNCNFgaj02trlGln1fXScLce5flJlk5caUP0vYvjkRgQ47qdyMc2IqK2oiWxkm5Zblegpbblt5fAIqR3JEqH0gy+12p24A7L7oIs02H6TIZVTguo5neBpiyp5yPcODfbJm2QIDAQAB";//141
//    private static final String PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCP0X9LYJS2v4tks6P36gnT3GNzRfOFoLTULduuPpUpYU3i+2ku8yeuNbqEw5ygv6CplAhctdfENGRK7qmBmOlZRBNlncThAFnkgQSfkiyB/n1ohCwkppnnscUzR2U65ng8blp6CMEbf84wsMdXb36F23qpNm5pC1dHTYSbHUeOmwIDAQAB";//116
    private static final String PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQClZ5btCXv8ukjAByffSzA2UURDAfDk03Rz/SE0SqQvBemuXJh4e9tzkV2ysCvDU/5P2f/CrxOzu/eJ66ZB2Wt2rVdouNc+NyR7to4sgyiDtskzlqUHduBeGDzbChUadsHwkvLFatErvWWevZFL4r/CJHSfsH1JeoWDCKNZe9D4OwIDAQABonsuccess";//131
...
//        getKeys();
        String s = "君不见黄河之水天上来，奔流到海不复回";
        System.out.println(encryptByPublicKey(s));
//        System.out.println(decryptByPrivateKey(encryptByPublicKey(s)));
        String serverString = "BvPPfFDWQMgIMki95SeHx/S2fJGWD+6mzY9lti+YhktpCNMg/vdJmQiF/bdWBuMIgeDv+ZIM4Lb++LzLZJCbh/M5otiIoJhIqJdtC+8gX2hSOXLFInguPI8H6eplI4dyPN9eSjFlMuCaxheZOEv96YhAVNGHzoymvPBgiXo4fzs=";
        System.out.println(decryptByPrivateKey(serverString));
    }
}